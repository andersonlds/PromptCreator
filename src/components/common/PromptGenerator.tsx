        ...
        <div className="space-y-12">
          ...
          <div className="card-container">
            ...
            <button 
              ...
              className="mt-10 w-full bg-indigo-600 hover:bg-indigo-500 text-white font-black py-6 rounded-2xl shadow-2xl shadow-indigo-500/20 transition-all flex items-center justify-center gap-3 text-xl tracking-wider uppercase disabled:opacity-50"
            >
              {isImproving ? (
                <>
                  <Sparkles className="w-6 h-6 animate-spin" /> REFINANDO COM IA...
                </>
              ) : (
                <>
